...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "examples")
  ...
  FILE(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/share/eo/examples/Lesson1" TYPE EXECUTABLE FILES
    "/home/emilie/workspace/MOCAD/PJ/EO/eo/tutorial/FirstBitGA-"
    "/home/emilie/workspace/MOCAD/PJ/EO/eo/tutorial/FirstBitGA"
    )
  FOREACH(file
      "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/share/eo/examples/Lesson1/FirstBitGA-"
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "examples")
  ...
  ENDFOREACH()
  FILE(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/share/eo/examples/Lesson1" TYPE EXECUTABLE FILES
    "/home/emilie/workspace/MOCAD/PJ/EO/eo/tutorial/FirstRealGA-"
    "/home/emilie/workspace/MOCAD/PJ/EO/eo/tutorial/FirstRealGA"
    )
  FOREACH(file
      "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/share/eo/examples/Lesson1/FirstRealGA-"
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "examples")
  ...
  ENDFOREACH()
  FILE(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/share/eo/examples/Lesson1" TYPE EXECUTABLE FILES
    "/home/emilie/workspace/MOCAD/PJ/EO/eo/tutorial/exercise1.3-"
    "/home/emilie/workspace/MOCAD/PJ/EO/eo/tutorial/exercise1.3"
    )
  FOREACH(file
      "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/share/eo/examples/Lesson1/exercise1.3-"
...
FILE(WRITE "/home/emilie/workspace/MOCAD/PJ/EO/eo/tutorial/${CMAKE_INSTALL_MANIFEST}" "")
FOREACH(file ${CMAKE_INSTALL_MANIFEST_FILES})
  FILE(APPEND "/home/emilie/workspace/MOCAD/PJ/EO/eo/tutorial/${CMAKE_INSTALL_MANIFEST}" "${file}\n")
ENDFOREACH(file)
